import { CleanBiddingData } from "../../ScrapedData/GameTypes";
import { BidAnalysisData } from "../Contracts/ExtractionContracts";
import { determineProbabilityMassDistribution } from "../Utilities/Stats";

export const analyzeBidDistributions = (bids: CleanBiddingData[]): BidAnalysisData => {
