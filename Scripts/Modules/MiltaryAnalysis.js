export const analyzeBattleAreas = (combatLogs) => {
...
export const analyzeBattleStrategies = (combatLogs) => {
...
export const analyzeProvinceDistributions = (combatLogs) => {
...
export const analyzeProvinceControl = (combatLogs) => {
...
export const analyzeArmyComposition = (combatLogs) => {
...
export const analyzeProvinceCountTimeline = (combatLogs) => {
...
export const analyzeFactionStats = (combatLogs) => {
