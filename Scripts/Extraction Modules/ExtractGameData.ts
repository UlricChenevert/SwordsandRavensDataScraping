import { GameClient, GameLog, IngameGameState, OrdersRevealed } from "../../ScrapedData/GameTypes.js";
...
export const extractLogData = (logs : GameLog[], Extractors : IGameLogDataExtractor<object>[], gameRoundToLogIndex : LogIndexToGameRound[]) => {
...
export const extractGameTurnData = (logs : GameLog[]) : LogIndexToGameRound[] => {
    ...
    logs.forEach((log, index)=>{
        ...
        const orderRevealed = logs[orderRevealedIndex].data as OrdersRevealed
