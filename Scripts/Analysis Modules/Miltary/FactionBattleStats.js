...
export const FactionBattleStatsTrialCombination = (trials, combinedData) => {
...
const combineFactionStats = (workingStatistic, newStatistic) => {
    if (newStatistic === undefined)
        return workingStatistic; // Nothing to combine
...
//# sourceMappingURL=FactionBattleStats.js.map